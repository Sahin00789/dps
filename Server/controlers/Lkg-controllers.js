...
const Student = new Lkg_students({studentName, fatherName, Adress, MobileNumber, Class, Roll, Session,  Attendence, 
...
{   const _id = req.params.id;
 ...
 doc = await Lkg_students.updateOne(({_id}),{'fMarks.fBengali': fBengali,'fMarks.fEnglish' : fEnglish,'fMarks.fMath' : fMath,'fMarks.fGk' : fGk, 'fMarks.fTotal' : ftl,'fMarks.fPosition' : fPosition  });
  res.send(doc); console.log(doc);  }
